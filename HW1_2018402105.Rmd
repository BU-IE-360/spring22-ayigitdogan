...
The data used in the analysis are extracted from [Electronic Data Delivery System](https://evds2.tcmb.gov.tr/), which is provided by the Central Bank of the Republic of Turkey, and from [Google Trends](https://trends.google.com/trends/). One can access the *xlsx* and *csv* files [here](https://github.com/BU-IE-360/spring22-ayigitdogan/blob/13a622ef1902a70ca260e7ab68eab4866d56c344/HW01_Data.zip). The R Markdown file for this document is provided [here](https://github.com/BU-IE-360/spring22-ayigitdogan/blob/5538ecce9f88eeae077854fd73635dcab87e1cd0/HW1_2018402105.Rmd).
